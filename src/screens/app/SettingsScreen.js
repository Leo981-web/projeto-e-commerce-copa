  ...
  return (
    <View style={{ marginBottom: 20 }}>
      ...
      <View
        style={[
          sectionStyles.block,
          { backgroundColor: cardBg, borderColor: dividerColor, shadowColor },
        ]}
      >
        {children}
      </View>
  ...
  return (
    ...
    >
      ...
      <View style={rowStyles.textWrap}>
        ...
        {subtitle ? (
          <Text style={[rowStyles.subtitle, { color: mutedColor }]}>
            {subtitle}
          </Text>
        ) : null}
      </View>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: screenBg }]}>
      ...
      >
        <SettingsSection
          ...
          shadowColor={isDarkMode ? "#000" : GREEN}
        >
          <SettingRow
            {...rowTheme}
            icon={isDarkMode ? "dark-mode" : "light-mode"}
            title={t("darkTheme")}
            subtitle={t("darkThemeSub")}
            right={
              <ToggleSwitch
                isOn={isDarkMode}
                onColor={NAVY_TRACK_LIGHT}
                offColor={isDarkMode ? "#374151" : "#D1D5DB"}
                thumbOnStyle={{ backgroundColor: NAVY_BLUE }}
                thumbOffStyle={{ backgroundColor: "#9CA3AF" }}
                size="medium"
        ...
        >
          <SettingRow
            ...
            onPress={() =>
              showAlert({
                title: t("cacheAlertTitle"),
                message: t("cacheAlertMessage"),
                type: "success",
              })
            }
            right={
